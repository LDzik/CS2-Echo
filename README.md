...
* **In-Game Overlay:** A click-through, transparent overlay that displays translated messages directly over your game.
...
Toggle the overlay visibility at any time using your configured global hotkey (default: `Ctrl + Shift + O`).
